...
def main(argv):
    ...
    protein_groups1 = results.ProteinGroupResults.from_mq_protein_proteins_file(protein_groups_file1)
    protein_groups2 = results.ProteinGroupResults.from_mq_protein_proteins_file(protein_groups_file2)
