...
def get_methods(args):
    ...
    # python3 -um picked_group_fdr --mq_evidence ${DATA_DIR}/Dongxue_mimic_final_runs/mimic_s0.5_m4_peptFDR0.1/evidence_all_cleaned.txt --perc_evidence ${DATA_DIR}/Dongxue_mimic_final_runs/mimic_s0.5_m4_peptFDR0.1/peptides.all.txt --fasta ${DATA_DIR}/fasta/uniprot-proteome_human_190327.with_mimic_s0.5_m4.fasta --enzyme trypsinp --cleavages 0 --figure_base_fn results/220812_0.01peptideFDR_investigation/protein-0.1peptideFDR --protein_groups_out ${DATA_DIR}/Dongxue_mimic_final_runs/mimic_s0.5_m4_peptFDR0.1/proteinGroups.txt | tee ${DATA_DIR}/Dongxue_mimic_final_runs/mimic_s0.5_m4_peptFDR0.1/proteinGroups.log
    
    # python3 -um picked_group_fdr --mq_evidence /media/kusterlab/internal_projects/active/Picked_group_fdr/Dongxue_mimic_final_runs/mimic_s0.5_m4_peptFDR0.1/evidence_all_cleaned_0.01peptideFDR_per_rawfile.txt --perc_evidence /media/kusterlab/internal_projects/active/Picked_group_fdr/Dongxue_mimic_final_runs/mimic_s0.5_m4_peptFDR0.1/peptides_0.01peptideFDR_per_rawfile.all.txt --fasta ${DATA_DIR}/fasta/uniprot-proteome_human_190327.with_mimic_s0.5_m4.fasta --enzyme trypsinp --cleavages 0 --figure_base_fn results/220812_0.01peptideFDR_investigation/protein-0.01peptideFDR --protein_groups_out ${DATA_DIR}/Dongxue_mimic_final_runs/mimic_s0.5_m4_peptFDR0.1/proteinGroups_0.01peptideFDR_per_rawfile.txt | tee ${DATA_DIR}/Dongxue_mimic_final_runs/mimic_s0.5_m4_peptFDR0.1/proteinGroups_0.01peptideFDR_per_rawfile.log
...
#    configs.append({'pickedStrategy' : PickedGroupStrategy(), 'scoreType' : ProteinScoringStrategy("Perc remap bestPEP"), 'grouping' : RescuedSubsetGrouping(), 'label' : 'Picked Protein Group FDR'})
    ...
    #configs.append({'pickedStrategy' : ClassicStrategy(), 'scoreType' : ProteinScoringStrategy("Perc remap multPEP razor"), 'grouping' : SubsetGrouping(), 'label' : 'MaxQuant Perc PEP' })
    #configs.append({'pickedStrategy' : PickedGroupStrategy(), 'scoreType' : ProteinScoringStrategy("Perc remap multPEP razor"), 'grouping' : SubsetGrouping(), 'label' : 'MaxQuant Perc PEP picked' })
#    configs.append({'pickedStrategy' : ClassicStrategy(), 'scoreType' : ProteinScoringStrategy("Perc remap bestPEP razor"), 'grouping' : SubsetGrouping(), 'label' : 'MaxQuant Perc bestPEP' })
    #configs.append({'pickedStrategy' : PickedGroupStrategy(), 'scoreType' : ProteinScoringStrategy("Perc remap bestPEP razor"), 'grouping' : SubsetGrouping(), 'label' : 'MaxQuant Perc bestPEP picked' })
    #configs.append({'pickedStrategy' : ClassicStrategy(), 'scoreType' : ProteinScoringStrategy("Perc remap bestPEP"), 'grouping' : RescuedSubsetGrouping(), 'label' : 'Classic Protein Group FDR'})
    #configs.append({'pickedStrategy' : PickedGroupStrategy("leading"), 'scoreType' : ProteinScoringStrategy("Perc remap bestPEP"), 'grouping' : RescuedSubsetGrouping(), 'label' : 'Picked Protein Group FDR'})
