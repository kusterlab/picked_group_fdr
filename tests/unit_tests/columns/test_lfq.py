...
class TestStabilizeLargeRatios:
    ...
    def test_applyLargeRatioStabilization_largeRatio_replacesWithIntensityRatio(
        ...
        result = _applyLargeRatioStabilization(
    ...
    def test_applyLargeRatioStabilization_mediumRatio_usesWeightedAverage(
    ...
    def test_applyLargeRatioStabilization_smallRatio_unchanged(
    ...
    def test_applyLargeRatioStabilization_zeroPeptideCount_skipped(
    ...
    def test_applyLargeRatioStabilization_missingPair_skipped(
        self, peptideIntensityListThreeFiles, experimentToIdxMap
    ):
